...
#####Global Vars # YOU NEED TO CHANGE THESE
$dt = (get-date).DateTime
$data_store = "C:\Users\tstark\Downloads\DCO-master\DCO-master\site_check\data_store"
$baseline_store = "C:\Users\tstark\Downloads\DCO-master\DCO-master\site_check\baselines"
$wait = 30
...
$route_base_hash = get-filehash "$baseline_store\baseline_route.xml"
...
$route_base_hash = Import-Clixml $baseline_store\baseline_route_hash.xml
